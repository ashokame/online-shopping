...
C:\Users\ashok_eshwarappa\.m2\repository\com\oracle\ojdbc14   attached in mail for 48 Months.

C:\Users\ashok_eshwarappa\.m2\repository\ojdbc\ojdbc\14-10gR2
...
CREATE TABLE address (
	...
	is_billing VARCHAR(20),
	is_shipping VARCHAR(20),
...
INSERT INTO category (id,name, description,image_url,is_active) VALUES (1,'Laptop', 'This is description for Laptop category!', 'CAT_1.png', 'true');
...
VALUES (1,'Ashok', 'ME', 'ADMIN', 'true', '$2a$06$ORtBskA2g5Wg0HDgRE5ZsOQNDHUZSdpJqJ2.PGXv0mKyEvLnKP7SW', 'ashoka@gmail.com', '8888888888');
INSERT INTO user_detail 
(id,first_name, last_name, role, enabled, password, email, contact_number) 
VALUES (2,'Ravindra', 'Jadeja', 'SUPPLIER', 'true', '$2a$06$bzYMivkRjSxTK2LPD8W4te6jjJa795OwJR1Of5n95myFsu3hgUnm6', 'rj@gmail.com', '9999999999');
INSERT INTO user_detail 
(id,first_name, last_name, role, enabled, password, email, contact_number) 
VALUES (3,'Ravichandra', 'Ashwin', 'SUPPLIER',  'true', '$2a$06$i1dLNlXj2uY.UBIb9kUcAOxCigGHUZRKBtpRlmNtL5xtgD6bcVNOK', 'ra@gmail.com', '7777777777');
INSERT INTO user_detail 
(id,first_name, last_name, role, enabled, password, email, contact_number) 
VALUES (4,'Ashok', 'ME', 'USER',  'true', '$2a$06$4mvvyO0h7vnUiKV57IW3oudNEaKPpH1xVSdbie1k6Ni2jfjwwminq', 'ashok@gmail.com', '7777777777');
...
VALUES (1,4, '110 Bangalore', 'Bangalore', 'Bangalore', 'Karnataka', 'India', '560100', 'true', 'false' );
